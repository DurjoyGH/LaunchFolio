...
> = {
  ...
  generating: { label: "Generating", badge: "info", description: "We are tailoring your portfolio content and layout..." },
  building: { label: "Building", badge: "info", description: "We are assembling your portfolio..." }, // Kept for legacy but skipped
  deploying: { label: "Publishing", badge: "warning", description: "We are publishing your portfolio online..." }, // Kept for legacy but skipped
...
const STEPS_ORDER: PortfolioStatus[] = ["queued", "generating", "deployed"];
